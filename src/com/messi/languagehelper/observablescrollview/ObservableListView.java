...
package com.messi.languagehelper.observablescrollview;
        ...
        if (mCallbacks != null) {
            switch (ev.getActionMasked()) {
                case MotionEvent.ACTION_DOWN:
                    LogUtil.CustomLog(TAG, "onTouchEvent: ACTION_DOWN");
                    mFirstScroll = mDragging = true;
                    mCallbacks.onDownMotionEvent();
                    break;
                case MotionEvent.ACTION_UP:
                case MotionEvent.ACTION_CANCEL:
                    LogUtil.CustomLog(TAG, "onTouchEvent: ACTION_UP|ACTION_CANCEL");
                    mDragging = false;
                ...
                if (firstVisibleChild != null) {
                    if (mPrevFirstVisiblePosition < firstVisiblePosition) {
                        ...
                        if (firstVisiblePosition - mPrevFirstVisiblePosition != 1) {
                            LogUtil.CustomLog(TAG, "Skipped some children while scrolling down: " + (firstVisiblePosition - mPrevFirstVisiblePosition));
                            for (int i = firstVisiblePosition - 1; i > mPrevFirstVisiblePosition; i--) {
                                if (0 < mChildrenHeights.indexOfKey(i)) {
                                    skippedChildrenHeight += mChildrenHeights.get(i);
                                    LogUtil.CustomLog(TAG, "Calculate skipped child height at " + i + ": " + mChildrenHeights.get(i));
                                } else {
                                    LogUtil.CustomLog(TAG, "Could not calculate skipped child height at " + i);
                        ...
                        if (mPrevFirstVisiblePosition - firstVisiblePosition != 1) {
                            LogUtil.CustomLog(TAG, "Skipped some children while scrolling up: " + (mPrevFirstVisiblePosition - firstVisiblePosition));
                    ...
                    LogUtil.CustomLog(TAG, "first: " + firstVisiblePosition + " scrollY: " + mScrollY + " first height: " + firstVisibleChild.getHeight() + " first top: " + firstVisibleChild.getTop());
                    ...
                    LogUtil.CustomLog(TAG, "first: " + firstVisiblePosition);
                }
            }
        }
    }
