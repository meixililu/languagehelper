...
public class StudyCategoryActivity extends Fragment implements OnClickListener{

	private View view;
	private FrameLayout study_part1,study_part2,study_part3,study_part4;
	public static StudyCategoryActivity mMainFragment;
	...
	public static StudyCategoryActivity getInstance(){
		if(mMainFragment == null){
			mMainFragment = new StudyCategoryActivity();
		}
